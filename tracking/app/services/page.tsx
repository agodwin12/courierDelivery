    ...
    const services: Service[] = [
        {
            id: 1,
            icon: (
                <svg className="w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 h-full flex items-center min-h-[400px] sm:min-h-[500px] lg:min-h-[70vh]">
                    <div className="text-center w-full">
                        <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                            <p className="text-[#8BC34A] text-sm sm:text-base lg:text-lg font-semibold mb-3 sm:mb-4">COMPREHENSIVE SOLUTIONS</p>
                            ...
                            <Link href="/track" className="inline-block px-6 sm:px-8 py-3 sm:py-4 bg-[#8BC34A] text-white font-semibold rounded-lg hover:bg-[#7CB342] transition-all hover:scale-105 hover:shadow-xl hover:shadow-[#8BC34A]/50">
                                Track Your Shipment
                            </Link>
                        </div>
                    </div>
            ...
            <section className="py-12 sm:py-16 lg:py-20 bg-gray-50">
                <div className="max-w-7xl mx-auto px-4 sm:px-6">
                    <div className="text-center mb-12 sm:mb-16 scroll-animate opacity-0 translate-y-8">
                        <p className="text-[#8BC34A] font-semibold text-sm sm:text-base lg:text-lg mb-3 sm:mb-4">WHAT WE OFFER</p>
                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
                        {services.map((service, idx) => (
                            <div
                                key={service.id}
                                className={`scroll-animate opacity-0 translate-y-8 group bg-white rounded-xl sm:rounded-2xl p-6 sm:p-8 shadow-lg hover:shadow-2xl transition-all duration-500 cursor-pointer transform hover:-translate-y-2`}
                                onMouseEnter={() => setActiveService(service.id)}
                                onMouseLeave={() => setActiveService(null)}
                                onClick={() => setActiveService(service.id)}
                            >
                                {/* Icon */}
                                <div className={`w-16 h-16 sm:w-20 sm:h-20 lg:w-24 lg:h-24 bg-gradient-to-br from-[#8BC34A] to-[#7CB342] rounded-xl sm:rounded-2xl flex items-center justify-center mb-4 sm:mb-6 transition-all duration-500 ${
                                ...
                                {/* Title */}
                                <h3 className="text-xl sm:text-2xl font-bold text-[#2d2d2d] mb-3 sm:mb-4 group-hover:text-[#8BC34A] transition-colors">
                                    {service.title}
                                </h3>
                                ...
                                <ul className="space-y-2 sm:space-y-3 mb-4 sm:mb-6">
                                    {service.features.map((feature, featureIdx) => (
                                        <li key={featureIdx} className="flex items-center gap-2 sm:gap-3 text-sm sm:text-base text-gray-700">
                                            <svg className="w-4 h-4 sm:w-5 sm:h-5 text-[#8BC34A] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                {/* CTA Button */}
                                <button className="w-full py-2.5 sm:py-3 bg-[#2d2d2d] text-white text-sm sm:text-base font-semibold rounded-lg group-hover:bg-[#8BC34A] transition-all duration-300">
                                    Learn More
                                </button>
                            </div>
                        ))}
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6">
                    <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center">
                        <div className="scroll-animate opacity-0 translate-x-[-50px]">
                            <p className="text-[#8BC34A] font-semibold text-sm sm:text-base lg:text-lg mb-3 sm:mb-4">WHY CHOOSE US</p>
                            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-[#2d2d2d] mb-4 sm:mb-6">
                                ...
                                {[
                                    ...
                                    <div key={idx}>
                                        <div className="flex justify-between mb-2">
                                            <span className="text-sm sm:text-base font-semibold text-[#2d2d2d]">{stat.label}</span>
                                            <span className="text-sm sm:text-base font-bold text-[#8BC34A]">{stat.percentage}%</span>
                                        </div>
                        ...
                        <div className="relative scroll-animate opacity-0 translate-x-[50px]">
                            <div className="relative h-64 sm:h-80 lg:h-[500px] rounded-xl sm:rounded-2xl overflow-hidden shadow-2xl">
                                ...
                                <div className="absolute bottom-4 sm:bottom-8 left-4 sm:left-8 right-4 sm:right-8 text-white">
                                    <h3 className="text-2xl sm:text-3xl font-bold mb-1 sm:mb-2">2.9K+</h3>
                                    <p className="text-sm sm:text-base lg:text-lg">Parcels Delivered Daily</p>
                                </div>
                            </div>

                            {/* Floating Cards */}
                            <div className="hidden sm:block absolute -top-4 sm:-top-6 -right-4 sm:-right-6 bg-white rounded-lg sm:rounded-xl shadow-xl p-4 sm:p-6 animate-float">
                                <div className="flex items-center gap-3 sm:gap-4">
                                    <div className="w-10 h-10 sm:w-12 sm:h-12 bg-[#8BC34A] rounded-full flex items-center justify-center flex-shrink-0">
                                        <svg className="w-5 h-5 sm:w-6 sm:h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                                        </svg>
                                    </div>
                                    <div>
                                        <p className="text-sm sm:text-base font-bold text-[#2d2d2d]">ISO Certified</p>
                                        <p className="text-xs sm:text-sm text-gray-600">Quality Assured</p>
                                    </div>
                                </div>
                            </div>

                            <div className="hidden sm:block absolute -bottom-4 sm:-bottom-6 -left-4 sm:-left-6 bg-white rounded-lg sm:rounded-xl shadow-xl p-4 sm:p-6 animate-float-delayed">
                                <div className="flex items-center gap-3 sm:gap-4">
                                    <div className="w-10 h-10 sm:w-12 sm:h-12 bg-[#8BC34A] rounded-full flex items-center justify-center flex-shrink-0">
                                        <svg className="w-5 h-5 sm:w-6 sm:h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <div>
                                        <p className="text-sm sm:text-base font-bold text-[#2d2d2d]">24/7 Support</p>
            ...
            <section className="py-12 sm:py-16 lg:py-20 bg-gradient-to-r from-[#8BC34A] to-[#7CB342]">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <Link href="/track" className="px-6 sm:px-8 py-3 sm:py-4 bg-white text-[#8BC34A] text-sm sm:text-base font-semibold rounded-lg hover:bg-gray-100 transition-all hover:scale-105 shadow-lg">
                            Track Shipment
                        </Link>
                        <Link href="/contact" className="px-6 sm:px-8 py-3 sm:py-4 bg-[#2d2d2d] text-white text-sm sm:text-base font-semibold rounded-lg hover:bg-black transition-all hover:scale-105 shadow-lg">
                            Request Quote
                        </Link>
                    </div>
                </div>
